...
const courseData = {
  ...
  modules: [
    {
      mainTitle: "Introduction to JavaScript 🌟",
      topics: [
        {
          subtitle: "What is JavaScript? 💻",
          text: "JavaScript is a versatile, high-level programming language used for web development to make pages interactive. 🖱️🔥"
        },
        {
          subtitle: "History 📜",
          text: "Created in 1995 by Brendan Eich, JavaScript has evolved into a modern language with ES6+ features."
        }
      ]
    },
    {
      mainTitle: "Basic Syntax ✍️",
      topics: [
        {
          subtitle: "Variables 🏷️",
          text: "Use let, const, or var to declare variables. Example: let x = 5;"
        },
        {
          subtitle: "Data Types 🔢",
